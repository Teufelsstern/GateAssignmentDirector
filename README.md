...
A shoutout is given to [Fenix2GSX](https://github.com/Fragtality/Fenix2GSX). Although zero source code or internal algorithms have been taken from Fenix2GSX, the project was helpful to garner initial understanding of controling GSX through LVAR.
