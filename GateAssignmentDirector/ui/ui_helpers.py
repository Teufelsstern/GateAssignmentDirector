...
COLORS = {
    ...
    "periwinkle": Color(
        "#a8b8d4", "#95a2bb", ["assign_gate_bg", "tab_selected_bg", "secondary_action"]
    ),
    ...
    "periwinkle_dark": Color(
        "#30384a", "#283040", ["assign_gate_text_active", "tab_selected_text"]
    ),
    "periwinkle_light": Color(
        "#cbd4e6", "#b4bdcf", ["assign_gate_text_inactive", "tab_unselected_text"]
    ),
    ...
    "salmon": Color(
        "#d4a5a0",
        "#bb918d",
        ["stop_monitoring_bg", "clear_override_bg", "destructive_action"],
    ),
    ...
    "purple_gray": Color(
        "#4a4050", "#403846", ["lilac_text", "salmon_text", "override_buttons_text"]
    ),
    ...
    "dusty_rose": Color(
        "#C67B7B", "#af6c6c", ["status_error", "status_stopped", "border_error"]
    ),
    ...
    "mustard": Color(
        "#D4A574", "#bb9166", ["status_warning", "airport_manual_override"]
    ),
    ...
    "charcoal_light": Color(
        "#2a2a2a", "#252525", ["bg_panel", "override_panel_bg", "tab_bg"]
    ),
    "charcoal_lighter": Color(
        "#3a3a3a", "#333333", ["border_default", "tab_unselected_hover"]
    ),
    ...
    "periwinkle_tint": Color(
        "#9BA8D9", "#8993bf", ["tab_selected_hover", "border_focus"]
    ),
}
